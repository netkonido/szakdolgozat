...
% Document's metadata
\title{Mesterséges intelligencián alapuló kiberbiztonsági önéletrajz generátor} % title
...
\supervisor{Lendák Imre} % internal supervisor's name
\affiliation{Oktató, Egyetemi docens} % internal supervisor's affiliation
...
\department{Adattudományi és Adattechnológiai Tanszék} % department's name
\city{Budapest} % city
